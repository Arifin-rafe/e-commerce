    ...
    <footer className="border-t py-12">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-4 px-4 lg:px-4">
        <div>
          ...
          <form className="flex">
            <input
              ...
              className="p-3 w-full text-sm border-t border-l border-b border-gray-300 rounded-l-md focus: ring-2 focus: ring-gray-500 transition-all"
              required
            />
            <button
              type="submit"
        ...
        <div>
          ...
          <p><FiPhoneCall className="inline-block mr-2"></FiPhoneCall>+8801677872082</p>
        </div>
      </div>
      {/* footer bottom */}
